...
if __name__ == "__main__":
    ...
    bs.update_masaniello_quote(1.8)
    bs.update_masaniello_result(1)

    bs.update_masaniello_quote(1.9)
    bs.update_masaniello_result(1)

    bs.update_masaniello_quote(1.5)
    print(bs.update_masaniello_result(0))

    bs.update_masaniello_quote(1.5)
    print(bs.update_masaniello_result(1))

    bs.update_masaniello_quote(1.7)
    print(bs.update_masaniello_result(0))
